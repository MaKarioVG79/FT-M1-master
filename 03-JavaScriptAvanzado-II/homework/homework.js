...
function cacheFunction(cb) {
  ...
  ese argumento; hecho eso, debe guardar el argumento junto con el resultado de la invocación (tip: usá un objeto 
    donde cada propiedad sea el argumento, y su valor el resultado de la correspondiente invocación a cb) de manera 
    que, la próxima vez que reciba el mismo argumento, no sea necesario volver a invocar a cb, porque el resultado 
...
let textoAsteriscos = crearCadena.bind(this.delimitadorIzquierda, "*", "*");
let textoGuiones = crearCadena.bind(this.delimitadorDerecha, "-", "-");
